(function(){
    ...
    var modules={
        ...
        "a-basic-application-framework-index":  {url:"$A/a/a-basic-application-framework/index.html",app:1},
        ...
        "bubble-background-app":		        {url:"$A/b/bubble-background/index.html",app:1},
        //"bookkeeping-app":  			        {url:"$A/b/bookkeeping-app/index.html",app:1},
        //"bookkeeping-app-wapp":  		        {url:"$A/b/bookkeeping-app-wapp/index.html",app:1},
        ...
        "contact-us-app":  			    {url:"$A/c/contact-us/index.html",app:1},
        ...
        "client-data-wapp":             {url:"$A/c/client-data-wapp.html",Table:"client-wapp",form_module:"client-form-wapp",router:1},
        "client-form-wapp":             {url:"$A/c/client-form-wapp.html",Table:"client-wapp"},
        ...
        "enquiry-app":      	  		{url:"$A/e/enquiry/index.html",app:1},         
        ...
        "event-calendar-app":  		    {url:"$A/e/event-calendar/index.html",app:1},
        ...
        "fountains-illumination-app":	{url:"$A/f/fountains-illumination-background/index.html",app:1},
        ...
        "fitness-app":                  {url:"$A/f/fitness/index.html",app:1},
        ...
        "medical-practitioner-app":     {url:"$A/m/medical-practitioner/index.html",app:1},
        ...
        "nasa-background-app":		    {url:"$A/n/nasa-background/index.html",app:1},
        "not-ready": 		            {url:"$A/u/under-construction.html",text:"Not Ready",router:1},
        "nyan":  		  	  			{url:"$A/n/nyan.html",router:1},
        "nyan-background-app":		    {url:"$A/n/nyan-background/index.html",app:1},
        ...
        "particle-background-app":      {url:"$A/p/particle-background/index.html",app:1},
        ...
        "purchase-order-request-app":           {url:"$A/p/purchase-order-request/index.html",app:1},
        ...
        "restaurant-app":    			        {url:"$A/r/restaurant-app/index.html",app:1},
        ...
        "snow-background-app":		    {url:"$A/s/snow-background/index.html",app:1},
        ...
        "survey-app":      	  		    {url:"$A/s/survey/index.html"},         
        "success":  		  	  		{url:"$A/s/success.html",router:1,app:1},
        "success-app":  		  	  	{url:"$A/s/success/index.html",app:1},
        "simple-app":  		  	  	    {url:"$A/s/simple/index.html",app:1},
        ...
        "woolcock-template-app":		{url:"$A/w/woolcock-template/index.html",app:1},
    ...
    //url_replace(modules,"wapp-bookkeeping-","$A","https://modules.vmiis.com/","http://127.0.0.1:8000/vmiis/modules");
    ...
    //astn
    var modules = {
        "panel-main-shq-astn": { url: "$A/panel-main-shq.html"},
        "panel-child-shq-astn": { url: "$A/panel-child-shq.html" },

        "project-shq-data": {
            url: "$A/project-shq-data.html", Table: "astn-shq-project-20003481", form_module: "project-shq-form", router: 1,
            child_panel: "panel-main-shq-astn"
        },
        "project-shq-form": { url: "$A/project-shq-form.html", Table: "astn-shq-project-20003481" },
        ...
        "online-questionnaire-setup-shq-astn": { url: "$A/online-questionnaire-setup.html", Table: "astn-shq-participant-20002391" },
        "online-questionnaire-app-shq-astn": { url: "$A/online-questionnaire/index.html" },

        "notes": { url: "$A/notes.html" },

        "consent-astn-data": { url: "$A/consent-astn-data.html", Table: "consent-astn-20002423", form_module: "consent-astn-form" },
        "consent-astn-form": { url: "$A/consent-astn-form.html", Table: "consent-astn-20002423", task_name:"Consent" },
        "background-information-astn-data": { url: "$A/background-information-astn-data.html", Table: "background-information-astn-20002400", form_module: "background-information-astn-form" },
        "background-information-astn-form": { url: "$A/background-information-astn-form.html", Table: "background-information-astn-20002400", task_name:"Background Information" },
        "general-astn-data": { url: "$A/general-astn-data.html", Table: "general-astn-20002401", form_module: "general-astn-form" },
        "general-astn-form": { url: "$A/general-astn-form.html", Table: "general-astn-20002401", task_name:"General" },
        "ethnicity-self-astn-data": { url: "$A/ethnicity-self-astn-data.html", Table: "ethnicity-self-astn-20002402", form_module: "ethnicity-self-astn-form" },
        "ethnicity-self-astn-form": { url: "$A/ethnicity-self-astn-form.html", Table: "ethnicity-self-astn-20002402", task_name:"Ethnicity" },
        "lifestyle-astn-data": { url: "$A/lifestyle-astn-data.html", Table: "lifestyle-astn-20002403", form_module: "lifestyle-astn-form" },
        "lifestyle-astn-form": { url: "$A/lifestyle-astn-form.html", Table: "lifestyle-astn-20002403", task_name:"Lifestyle" },
        "medical-history-astn-data": { url: "$A/medical-history-astn-data.html", Table: "medical-history-astn-20002404", form_module: "medical-history-astn-form" },
        "medical-history-astn-form": { url: "$A/medical-history-astn-form.html", Table: "medical-history-astn-20002404", task_name:"Medical_History" },
        "sleep-disorder-patterns-astn-data": { url: "$A/sleep-disorder-patterns-astn-data.html", Table: "sleep-disorder-patterns-astn-20002405", form_module: "sleep-disorder-patterns-astn-form" },
        "sleep-disorder-patterns-astn-form": { url: "$A/sleep-disorder-patterns-astn-form.html", Table: "sleep-disorder-patterns-astn-20002405", task_name:"Sleep HQDP" },
        "sleep-hygiene-index-astn-data": { url: "$A/sleep-hygiene-index-astn-data.html", Table: "sleep-hygiene-index-astn-20003571", form_module: "sleep-hygiene-index-astn-form" },
        "sleep-hygiene-index-astn-form": { url: "$A/sleep-hygiene-index-astn-form.html", Table: "sleep-hygiene-index-astn-20003571", task_name:"Sleep Hygiene Index" },
        "family-sleep-history-astn-data": { url: "$A/family-sleep-history-astn-data.html", Table: "family-sleep-history-astn-20002406", form_module: "family-sleep-history-astn-form" },
        "family-sleep-history-astn-form": { url: "$A/family-sleep-history-astn-form.html", Table: "family-sleep-history-astn-20002406", task_name:"Family Sleep History" },
        "medications-astn-data": { url: "$A/medications-astn-data.html", Table: "medications-astn-20002407", form_module: "medications-astn-form" },
        "medications-astn-form": { url: "$A/medications-astn-form.html", Table: "medications-astn-20002407", task_name:"Medications" },
        "rec-drug-astn-data": { url: "$A/rec-drug-astn-data.html", Table: "rec-drug-astn-20003574", form_module: "rec-drug-astn-form" },
        "rec-drug-astn-form": { url: "$A/rec-drug-astn-form.html", Table: "rec-drug-astn-20003574", task_name:"Recreational Drugs" },
        "ess-astn-data": { url: "$A/ess-astn-data.html", Table: "ess-astn-20002408", form_module: "ess-astn-form" },
        "ess-astn-form": { url: "$A/ess-astn-form.html", Table: "ess-astn-20002408", task_name:"Epworth Sleepiness Scale" },
        "map-astn-data": { url: "$A/map-astn-data.html", Table: "map-astn-20002409", form_module: "map-astn-form" },
        "map-astn-form": { url: "$A/map-astn-form.html", Table: "map-astn-20002409", task_name:"Multivariate Apnea Prediction Questionnaire" },
        "isi-astn-data": { url: "$A/isi-astn-data.html", Table: "isi-astn-20002410", form_module: "isi-astn-form" },
        "isi-astn-form": { url: "$A/isi-astn-form.html", Table: "isi-astn-20002410", task_name:"Insomnia Severity Index" },
        "restless-leg-astn-data": { url: "$A/restless-leg-astn-data.html", Table: "restless-leg-astn-20002411", form_module: "restless-leg-astn-form" },
        "restless-leg-astn-form": { url: "$A/restless-leg-astn-form.html", Table: "restless-leg-astn-20002411", task_name:"Restless Legs" },
        "me-astn-data": { url: "$A/me-astn-data.html", Table: "me-astn-20002412", form_module: "me-astn-form" },
        "me-astn-form": { url: "$A/me-astn-form.html", Table: "me-astn-20002412", task_name:"Horne & &#214;stberg Morningness-Eveningness Composite Questionnaire" },
        "fosq-astn-data": { url: "$A/fosq-astn-data.html", Table: "fosq-astn-20002413", form_module: "fosq-astn-form" },
        "fosq-astn-form": { url: "$A/fosq-astn-form.html", Table: "fosq-astn-20002413", task_name:"Functional Outcomes of Sleep Questionnaire" },
        "psqi-astn-data": { url: "$A/psqi-astn-data.html", Table: "psqi-astn-20003576", form_module: "psqi-astn-form" },
        "psqi-astn-form": { url: "$A/psqi-astn-form.html", Table: "psqi-astn-20003576", task_name:"Pittsburgh Sleep Quality Index" },
        "phq-astn-data": { url: "$A/phq-astn-data.html", Table: "phq-astn-20002414", form_module: "phq-astn-form" },
        "phq-astn-form": { url: "$A/phq-astn-form.html", Table: "phq-astn-20002414", task_name:"Patient Health Questionnaire (PHQ-9)" },
        "gad7-astn-data": { url: "$A/gad7-astn-data.html", Table: "gad7-astn-20002415", form_module: "gad7-astn-form" },
        "gad7-astn-form": { url: "$A/gad7-astn-form.html", Table: "gad7-astn-20002415", task_name:"Generalised Anxiety Disorder (GAD-7)" },
        "dass-astn-data": { url: "$A/dass-astn-data.html", Table: "dass-astn-20002416", form_module: "dass-astn-form" },
        "dass-astn-form": { url: "$A/dass-astn-form.html", Table: "dass-astn-20002416", task_name:"Depression Anxiety Stress Scale (DASS-21)" },
        "fss-astn-data": { url: "$A/fss-astn-data.html", Table: "fss-astn-20002417", form_module: "fss-astn-form" },
        "fss-astn-form": { url: "$A/fss-astn-form.html", Table: "fss-astn-20002417", task_name:"Fatigue Severity Scale (FSS)" },
        "sds-astn-data": { url: "$A/sds-astn-data.html", Table: "sds-astn-20002418", form_module: "sds-astn-form" },
        "sds-astn-form": { url: "$A/sds-astn-form.html", Table: "sds-astn-20002418", task_name:"Sheehan Disability Scale (SDS)" },
        "hwpq-astn-data": { url: "$A/hwpq-astn-data.html", Table: "hwpq-astn-20002419", form_module: "hwpq-astn-form" },
        "hwpq-astn-form": { url: "$A/hwpq-astn-form.html", Table: "hwpq-astn-20002419", task_name:"Health & Work Performance Questionnaire" },
        "shiftwork-astn-data": { url: "$A/shiftwork-astn-data.html", Table: "shiftwork-astn-20002420", form_module: "shiftwork-astn-form" },
        "shiftwork-astn-form": { url: "$A/shiftwork-astn-form.html", Table: "shiftwork-astn-20002420", task_name:"Shiftwork" },
        "shiftworkii-astn-data": { url: "$A/shiftworkii-astn-data.html", Table: "shiftworkii-astn-20003584", form_module: "shiftworkii-astn-form" },
        "shiftworkii-astn-form": { url: "$A/shiftworkii-astn-form.html", Table: "shiftworkii-astn-20003584", task_name:"Shiftwork II" },
        "mva-astn-data": { url: "$A/mva-astn-data.html", Table: "mva-astn-20002421", form_module: "mva-astn-form" },
        "mva-astn-form": { url: "$A/mva-astn-form.html", Table: "mva-astn-20002421", task_name:"Motor Vehicle Accidents" },
        "wa-astn-data": { url: "$A/wa-astn-data.html", Table: "wa-astn-20002422", form_module: "wa-astn-form" },
        "wa-astn-form": { url: "$A/wa-astn-form.html", Table: "wa-astn-20002422", task_name:"Workplace Accidents" },
        "thank-you-astn-form": { url: "$A/thank-you-astn-form.html", task_name:"Thank You" }
    }
    var prefix="astn-";
    ...
    //apps
    var modules={
        "template-001":  		  		        {url:"$T/a/a-simple-application/index.html"},
        "aaxsys":  		  		                {url:"$T/a/aaxsys/index.html"},
        "bookkeeping-app":  			        {url:"$T/b/bookkeeping/index.html",app:1},
        "bookkeeping-app-wapp":  		        {url:"$T/b/bookkeeping-wappsystem/index.html",app:1},
    }
    url_replace(modules,"","$T","https://app-templates.vmiis.com/","http://127.0.0.1:8000/vmiis/app-templates");
    //-------------------------------------------------------------------------------------
