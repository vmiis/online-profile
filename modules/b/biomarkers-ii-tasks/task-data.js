...
//-------------------------------------
if(m.fields==undefined) m.fields="_Form,Status|S3,Notes|NT,Participant_ID|Participant_uid,Participant,"+fields+",Submit_date,Submitted_by,_Delete";
//-------------------------------------
}
else{
//-------------------------------------
...
//-------------------------------------
if(m.fields==undefined) m.fields="_Form,_Status,_Notes,_Participant_ID,"+fields+",Submit_date,Submitted_by,_Delete";
}